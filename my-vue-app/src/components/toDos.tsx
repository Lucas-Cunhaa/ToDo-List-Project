           ...
           {state.toLowerCase() === "done" && 
            <div className="task-group done">
              ...
              <select
                  ...
                  onChange={(e) => handleChange(id, e.target.value)}
                >
                  <option className="task-state" value="ToDo">ToDo</option>
                  <option className="task-state" value="Doing">Doing</option>
                  <option className="task-state" value="Done">Done</option>
                </select>
