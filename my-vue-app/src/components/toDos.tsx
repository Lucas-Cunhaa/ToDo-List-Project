...
const ToDo = () => {
  ...
  return (
    <>
      {ToDo.map(({ id, title, description, state ,member }: ToDo) => (
        <div key={id}>
          ...
          <div className="to-do">
            ...
            <div className="to-do-right">
                <select id="select-state" className="to-do-select-state">
                    <option key={id} value={state}></option>
                    <option key={id} value="doing" onClick={()=> setState("doing")}></option>
                    <option key={id} value="done" onClick={()=> setState("done")}></option>
                </select>
