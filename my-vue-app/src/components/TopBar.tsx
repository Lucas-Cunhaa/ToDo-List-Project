...
return (
    <div className="nav-top">
        ...
        <svg className="delete-svg" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button >
        <svg className="small-plus-svg" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
